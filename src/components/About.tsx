        ...
        <div className="relative mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="order-2 md:order-1">
              <div className="p-6 md:p-8 border-2 border-white rounded-2xl bg-transparent interactive group hover:scale-105 transition-all duration-300 max-w-2xl" style={{boxShadow: '0 0 15px rgba(255, 255, 255, 0.3)'}}>
