...
const MP_PREFERENCE_ID = 'SUA_PREFERENCE_ID_R7_50'; // TODO: Preferência configurada para o valor de R$7,50
...
const createMercadoPagoWallet = async () => {
  ...
  walletBrickController = await bricksBuilder.create('wallet', 'walletContainer', {
    ...
    callbacks: {
      onReady: () => {
        toggleButtonState(false, 'Garantir Minha Vaga por R$7,50');
